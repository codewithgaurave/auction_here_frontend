...
const SidebarItem = memo(({ route, isActive, themeColors, onClose }) => {
  ...
  return (
    <Link
      ...
      onMouseEnter={(e) => {
        if (!isActive) {
          e.currentTarget.style.backgroundColor = themeColors.hover?.background || `${themeColors.primary}10`;
        ...
        <div className="p-4 border-t" style={{borderColor: themeColors.border}}>
          <div className="flex items-center mb-4 p-3 rounded-lg" style={{backgroundColor: themeColors.background}}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs opacity-75 truncate" style={{color: themeColors.textSecondary}}>
